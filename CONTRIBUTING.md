# Contributing to SoroGuard

Thank you for your interest in contributing to SoroGuard — Automated Vulnerability Detection & Security Intelligence for Soroban smart contracts. This guide covers everything you need to get started.
...
SoroGuard participates in the **Stellar Drips Wave** program. Funded issues are tagged with the `Stellar Wave` label on GitHub and detailed in the project's issue list.
...
### Tech Stack Context:
* **Core Technologies:** Rust (wasmparser) for engine, React/Vite for app, Soroban/Rust for fixtures

### Setup Commands:
```bash
# Clone the repository
git clone https://github.com/soroguard/soroguard-engine
cd soroguard-engine

# Run tests
cargo test (engine/fixtures) or npm test (app)
```
...
Thank you for contributing to SoroGuard! 🚀
